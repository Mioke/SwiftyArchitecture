...
public extension Notification.Name {
  static let appContextChangedNotification: Notification.Name = .init(rawValue: "kAppContextChangedNotification")
}
...
public class AppContext: NSObject {
  ...
  public internal(set) static var current: AppContext = standard {
    didSet {
      ...
      NotificationCenter.default.post(name: .appContextChangedNotification, object: current)
    }
  }
